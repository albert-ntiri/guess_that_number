...
def valid_selection_copy():
    return ValidSelection(objects_fake_global)
...
def invalid_selection_copy(errors):
    ...
    return InvalidSelection(objects_fake_global, invalid_error, ("1.5", "9.8"))
...
def game_initializer_copy():
    return GameInitializer(objects_fake_global)
...
def test_initialize_game_medium_db(game_initializer_copy, sqlite_db_fake, test_db_path):
    sqlite_db_fake.run_query("DELETE FROM session;", _db_path=test_db_path)
    sqlite_db_fake.run_query("DELETE FROM game;", _db_path=test_db_path)
    level_medium = game_initializer_copy._data.get_sub_data_object("levels", "medium")
    game_initializer_copy._settings._level_obj = level_medium
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
...
def test_initialize_game_medium_hints_more_than_two_hints(game_initializer_copy):
    level_medium = game_initializer_copy._data.get_sub_data_object("levels", "medium")
    game_initializer_copy._settings._level_obj = level_medium
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
...
def test_initialize_game_medium_hints_relevant_hints_matches_hint_pool(game_initializer_copy):
    level_medium = game_initializer_copy._data.get_sub_data_object("levels", "medium")
    game_initializer_copy._settings._level_obj = level_medium
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
...
def test_initialize_game_hard_db(game_initializer_copy, sqlite_db_fake, test_db_path):
    sqlite_db_fake.run_query("DELETE FROM session;", _db_path=test_db_path)
    sqlite_db_fake.run_query("DELETE FROM game;", _db_path=test_db_path)
    level_hard = game_initializer_copy._data.get_sub_data_object("levels", "hard")
    game_initializer_copy._settings._level_obj = level_hard
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
...
def test_initialize_game_hard_hints_more_than_two_hints(game_initializer_copy):
    level_hard = game_initializer_copy._data.get_sub_data_object("levels", "hard")
    game_initializer_copy._settings._level_obj = level_hard
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
...
def test_initialize_game_hard_hints_relevant_hints_matches_hint_pool(game_initializer_copy):
    level_hard = game_initializer_copy._data.get_sub_data_object("levels", "hard")
    game_initializer_copy._settings._level_obj = level_hard
    game_initializer_copy._text_display._variables.display_variable_text("low_range", "")
    game_initializer_copy._text_display._variables.display_variable_text("high_range", "")
