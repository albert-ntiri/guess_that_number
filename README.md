...
## Testing
Testing was a major component of developing this application.  I initially tested it manually, at first, which included a series of steps, starting from the micro-level and gradually increasing the scope.  Once I had everything working, I created a suite of automated unit tests to make regression testing easier and quicker.  The test suite can be found in the current version of the code.
